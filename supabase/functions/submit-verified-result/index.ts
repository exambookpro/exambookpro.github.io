...
Deno.serve(async(req)=>{
 ...
 try{
  ...
  return new Response(JSON.stringify({ok:true,result,review,scoring:{marks_per_correct:marks,negative_per_wrong:negative,max_score:maxScore}}),{status:200,headers:{...cors,"Content-Type":"application/json"}});
